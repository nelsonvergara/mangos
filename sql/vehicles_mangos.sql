...
UPDATE `creature_template` SET `VehicleId` = 87 WHERE `entry` = 28817; -- Mine Car (hack)
...
UPDATE creature_template SET speed_walk = 1,speed_run = 1.5 WHERE entry IN (28782,33062);
